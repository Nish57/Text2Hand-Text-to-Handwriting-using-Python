...
fileName = "sampleText.txt" # path of your text file
...
BG=Image.open("fonts/bg.png") #path of page(background)photo (I have used blank page)
...
for i in txt.read().replace("\n",""):
        cases = Image.open("fonts/{}.png".format(str(ord(i))))
